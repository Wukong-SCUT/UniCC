...
from baseline.IPSO.optimizer import Optimizer  # abstract class for all Black-Box Optimizers (BBO)
...
class PSO(Optimizer):
    ...
    For some interesting applications of `PSO`/`CBO` in diverse areas, please refer to
    ...
    `[Menke et al., 2023, Ph.D. Dissertation (Harvard University)]
    <https://nrs.harvard.edu/URN-3:HUL.INSTREPOS:37371898>`_,
