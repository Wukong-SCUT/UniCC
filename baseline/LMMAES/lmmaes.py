...
from baseline.LMMAES.es import ES  # abstract class of all Evolution Strategies (ES) classes
...
class LMMAES(ES):
    ...
    def iterate(self, z=None, d=None, mean=None, tm=None, y=None, args=None):
        ...
        for k in range(self.n_individuals):
            ...
            x_batch.extend(mean + self.sigma * d[k])

        # 转换为 NumPy 矩阵进行批量评估
        x_batch = np.array(x_batch)
        y = self._evaluate_fitness(x_batch, args)
